    ...
    <div className="flex flex-col items-center justify-center space-y-8 py-12 text-center w-full max-w-md mx-auto">
      ...
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground max-w-[320px] mx-auto leading-relaxed text-sm">
          Welcome to StarX Study, <span className="font-semibold text-white">{data.fullName}</span>! We&apos;ve sent a verification link to <span className="font-medium text-white">{data.email}</span>.
        </p>
      </div>

      <div className="p-4 rounded-xl border border-border bg-card w-full text-xs text-muted-foreground space-y-1 text-left">
      ...
      <div className="w-full space-y-3 pt-2">
        <Link
          ...
          className="group flex w-full items-center justify-center gap-2 rounded-lg bg-primary px-4 py-3 text-sm font-semibold text-white hover:bg-[#22C55E] transition-all shadow-sm"
        >
