  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col space-y-8 w-full max-w-md mx-auto">
      ...
      <div className="space-y-4">
          ...
          <div className="relative">
            ...
            <input
              ...
              className={`block w-full h-11 rounded-lg border bg-card text-white ${
                errors.fullName ? 'border-red-500/50 focus:border-red-500 focus:ring-red-500/20' : 'border-border focus:border-primary focus:ring-primary/20'
        ...
        <div className="space-y-1">
          ...
          <div className="relative">
            ...
            <input
              ...
              className={`block w-full h-11 rounded-lg border bg-card text-white ${
                errors.email ? 'border-red-500/50 focus:border-red-500 focus:ring-red-500/20' : 'border-border focus:border-primary focus:ring-primary/20'
              } pl-10 px-3 py-2 text-sm placeholder-muted-foreground focus:outline-none focus:ring-2`}
        ...
        <div className="space-y-1">
          <label className="text-sm font-medium text-foreground">Create your password</label>
          <div className="relative">
            <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
            ...
            <input
              ...
              className={`block w-full h-11 rounded-lg border bg-card text-white ${
                errors.password ? 'border-red-500/50 focus:border-red-500 focus:ring-red-500/20' : 'border-border focus:border-primary focus:ring-primary/20'
              } pl-10 pr-10 px-3 py-2 text-sm placeholder-muted-foreground focus:outline-none focus:ring-2`}
              placeholder="••••••••"
            />
            <button
              type="button"
        ...
        <div className="space-y-1">
          ...
          <div className="relative">
            ...
            <input
              ...
              className={`block w-full h-11 rounded-lg border bg-card text-white ${
                errors.confirmPassword ? 'border-red-500/50 focus:border-red-500 focus:ring-red-500/20' : 'border-border focus:border-primary focus:ring-primary/20'
              } pl-10 pr-10 px-3 py-2 text-sm placeholder-muted-foreground focus:outline-none focus:ring-2`}
              placeholder="••••••••"
            />
            <button
