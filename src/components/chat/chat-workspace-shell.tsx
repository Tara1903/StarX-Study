...
export function ChatWorkspaceShell({ children }: ChatWorkspaceShellProps) {
  return (
    <div className="h-screen w-full flex overflow-hidden bg-background select-text">
      {/* Primary Desktop Chat Sidebar (Hidden on Mobile) */}
      <aside
        aria-label="Chat conversations"
        className="hidden lg:flex w-[320px] lg:w-[350px] xl:w-[380px] h-full shrink-0 flex-col border-r border-border select-none z-10"
      >
