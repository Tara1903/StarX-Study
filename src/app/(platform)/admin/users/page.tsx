      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-between items-center bg-card p-4 rounded-lg border border-border">
        <div className="relative w-full sm:w-72">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2 border border-border rounded-md bg-transparent text-foreground focus:outline-none focus:ring-2 focus:ring-primary"
          />
        </div>
        <div className="flex gap-2 w-full sm:w-auto">
          <select className="border border-border rounded-md px-3 py-2 bg-transparent text-foreground focus:outline-none focus:ring-2 focus:ring-primary [&>option]:bg-card [&>option]:text-foreground">
                  ...
                  <tr key={member.id} className="hover:bg-muted/50 transition-colors">
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        <div className="h-10 w-10 flex-shrink-0 bg-muted rounded-full overflow-hidden relative">
                        ...
                        <div className="ml-4">
                          ...
                          <div className="text-sm text-muted-foreground">ID: {member.profiles?.id.substring(0, 8)}...</div>
                        </div>
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
